...
module.exports = class GuildMemberRemove extends Event {
    ...
    async exec(member) {
        ...
        const channel = this.client.channels.cache.get(data.guild?.goodbyeChannel);
        ...
        let attach = new MessageAttachment(canvas.toBuffer(), "goodbye.png");
        return channel.send({ content: `Goodbye ${member} !`, files: [attach] });
    }
}